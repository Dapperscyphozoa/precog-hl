...
PURE_14 = {
    ...
    'ETH':    {'sigs':['BB'],'flt':'conv','RH':70,'RL':30,'TP':0.1,'SL':0.02},
    'DOGE':   {'sigs':['PV'],'flt':'none','RH':78,'RL':22,'TP':0.08,'SL':0.03},
    'NEAR':   {'sigs':['PV','BB'],'flt':'conv','RH':70,'RL':30,'TP':0.08,'SL':0.03},
    'ENA':    {'sigs':['PV','BB'],'flt':'none','RH':70,'RL':30,'TP':0.1,'SL':0.015},
    'ALT':    {'sigs':['PV','BB'],'flt':'conv','RH':70,'RL':30,'TP':0.06,'SL':0.03},
    'ASTER':  {'sigs':['PV','BB'],'flt':'conv','RH':70,'RL':30,'TP':0.06,'SL':0.03},
    'BERA':   {'sigs':['PV','BB'],'flt':'none','RH':70,'RL':30,'TP':0.06,'SL':0.02},
    'FET':    {'sigs':['BB'],'flt':'none','RH':70,'RL':30,'TP':0.08,'SL':0.03},
    'IMX':    {'sigs':['BB'],'flt':'none','RH':70,'RL':30,'TP':0.06,'SL':0.02},
    'PROMPT': {'sigs':['PV'],'flt':'conv','RH':78,'RL':22,'TP':0.1,'SL':0.03},
    'RENDER': {'sigs':['BB'],'flt':'conv','RH':70,'RL':30,'TP':0.08,'SL':0.03},
    'STRK':   {'sigs':['BB'],'flt':'none','RH':70,'RL':30,'TP':0.08,'SL':0.03},
    'SUPER':  {'sigs':['BB'],'flt':'none','RH':70,'RL':30,'TP':0.06,'SL':0.03},
    'W':      {'sigs':['BB'],'flt':'none','RH':70,'RL':30,'TP':0.08,'SL':0.015},
    'WCT':    {'sigs':['PV','BB'],'flt':'none','RH':70,'RL':30,'TP':0.1,'SL':0.02},
    'WLFI':   {'sigs':['PV'],'flt':'none','RH':70,'RL':30,'TP':0.06,'SL':0.03},

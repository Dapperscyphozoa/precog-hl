...
COINS = ['TST','CHILLGUY','VVV','ZEC','FARTCOIN','XPL','ZEREBRO','HMSTR','ENA','MERL','WLD','TAO','BRETT','WCT','kPEPE','AAVE','GRASS','DOT','ETH','HYPE','kNEIRO','0G','SPX','LDO','PUMP','GOAT','JTO','BLUR','BOME','MORPHO','LINEA','SYRUP','PENGU','BIO','SOL','BTC','SUI','TIA','BERA','POPCAT','UNI','BNB','APT','RENDER','TRUMP','SUSHI','AR','HEMI','MEW','STBL','IP','AVAX','AVNT','ORDI','GRIFFAIN','ALT','ASTER','MELANIA','APE','STRK','OP','PROMPT','GALA','SEI','NEAR','FET','WIF','LINK','XRP','MEME','kBONK','POL','EIGEN','FIL','YGG','ARB','ME','COMP','BIGTIME','DYDX','LAYER','ETC','ANIME','kFLOKI','NEO','HBAR','PENDLE','INJ','POLYX','JUP','SOPH','CFX','WLFI','LTC','ADA','GMX','ZORA','PROVE','CRV','KAS','ETHFI','ZK','REZ','NIL']
